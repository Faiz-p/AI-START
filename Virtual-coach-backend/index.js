...
const sendIntroduction = async (res, name = "Wilson") => {
  const text = `Hi ${name}, I’m Sophia, your explorer and companion, Are you ready to be guided through exciting adventures and opportunities? Whether you're exploring new horizons or planning your next big move, I'm here with you every step of the way. Let's find your unique path and unlock endless possibilities together!`;
...
app.post("/chat", async (req, res) => {
  ...
  const name = req.query.name || "Wilson";
  // Send the introduction message with the provided name
  await sendIntroduction(res, name);
});
